 ...
 */
  ...
  /* "darkflow/cython_utils/nms.pyx":69
 * 
 * 
 ...
 */
      ...
      /* "darkflow/cython_utils/nms.pyx":83
 *                     final_probs[index2,class_loop]=0
 *             bb=BoundBox(class_length)
 *             bb.x = final_bbox[index, 0]             # <<<<<<<<<<<<<<
 *             bb.y = final_bbox[index, 1]
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_darkflow_utils_box, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
